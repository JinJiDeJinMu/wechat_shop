<template>
	<view>
<view class="index-header-bg">
  <image src="/static/img/index-bg.png" mode="widthFix"></image>
</view>
<view class="index-header-box" @tap="selectToggle">
  <image src="/static/img/area.png" class="area"></image>
  <text>{{nowText==" "?propArray[0].name:nowText}}</text>
  <image src="/static/img/down.png" class="down" :animation="animationData"></image>
</view>
