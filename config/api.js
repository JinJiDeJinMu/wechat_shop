...
module.exports = {
	getQRCode: NewApiRootUrl + 'getQRCode',
	TcentConfigMapKey: 'W57BZ-JDB6X-XPA4H-Z76MI-73FF2-24BT4',
	//地图key
	WriteOffUrl: NewApiRootUrl + 'v2/writeoff/writeOffCodeExecute',
	WriteOffCodeNotify: NewApiRootUrl + 'v2/writeoff/writeOffCodeNotify',
	IndexUrlNewGoods: NewApiRootUrl + 'index/newGoods',
	//
	IndexUrlHotGoods: NewApiRootUrl + 'index/hotGoods',
	//首页数据接口
	...
	//公告
	IndexUrlBrand: NewApiRootUrl + 'index/brand',
	...
	//首页数据接口IndexUrlChannel
	IndexUrlSkill: NewApiRootUrl + 'index/secKill',
	//首页秒杀产品
	...
	//微信登录
	//AuthLoginByWeixin: WxApiRootUrl + 'v2/auth/wxLogin.do', //微信登录
	...
	//新品
	GoodsHot: NewApiRootUrl + 'goods/hot',
	//热门
	GoodsRelated: NewApiRootUrl + 'goods/related',
	//商品详情页的关联商品
	BrandList: NewApiRootUrl + 'brand/list',
	//品牌列表
	BrandDetail: NewApiRootUrl + 'brand/detail',
	//品牌详情
	CartList: NewApiRootUrl + 'cart/index',
	//获取购物车的数据
	CartAdd: NewApiRootUrl + 'cart/add',
	// 添加商品到购物车
	CartAdddd: NewApiRootUrl + 'goods/detail',
	BuyAdd: NewApiRootUrl + 'buy/add',
	// 直接购买
	...
	// 获取购物车商品件数
	CartCheckout: NewApiRootUrl + 'cart/checkout',
	// 下单前信息确认
	BuyCheckout: NewApiRootUrl + 'buy/checkout',
	// 下单前信息确认
	ShopOrderList: WxApiRootUrl + 'v2/order/merchantlist.json',
	OrderSubmit: WxApiRootUrl + 'v2/order/submit.do',
	// 提交订单
	OrderList: WxApiRootUrl + 'v2/order/list.json',
	//订单列表
	OrderDetail: WxApiRootUrl + 'v2/order/detail.json',
	//订单详情
	OrderCancel: WxApiRootUrl + 'v2/order/cancelOrder.do',
	//取消订单
	OrderConfirm: WxApiRootUrl + 'v2/order/confirmOrder.do',
	//确认收货
	OrderQuery: NewApiRootUrl + 'pay/query',
	OrderSuccess: WxApiRootUrl + 'v2/order/updateSuccess.do',
	OrderShareDistributionList: WxApiRootUrl + 'v2/distribution/getUserShareOrder.json',
	...
	//专题详情
	TopicRelated: NewApiRootUrl + 'topic/related',
	//相关专题
	SearchIndex: NewApiRootUrl + 'search/index',
	//搜索页面数据
	...
	AddressDetail: NewApiRootUrl + 'address/detail',
	//收货地址详情
	AddressSave: NewApiRootUrl + 'address/save',
	//保存收货地址
	AddressDelete: NewApiRootUrl + 'address/delete',
	//保存收货地址
	RegionList: NewApiRootUrl + 'region/list',
	//获取区域列表
	FootprintList: NewApiRootUrl + 'footprint/list',
	//足迹列表
	FootprintDelete: NewApiRootUrl + 'footprint/delete',
	//删除足迹
	FeedbackAdd: NewApiRootUrl + 'feedback/save',
	//添加反馈
	SmsCode: NewApiRootUrl + 'sendRegisterCode',
	//发送短信
	BindMobile: NewApiRootUrl + 'inviteReg',
	//fx注册
	Login: NewApiRootUrl + 'auth/login',
	//账号登录
	...
	//新增客户
	CustomerEdit: NewApiRootUrl + 'customer/update.do',
	//修改客户
	CustomerList: NewApiRootUrl + 'customer/queryList.do',
	//客户列表查询分页
	AllCustomerList: NewApiRootUrl + 'customer/queryAllList.do',
	//客户列表查询分页
	UpkeepList: NewApiRootUrl + 'upkeep/queryUpkeepList.do',
	//客户管理列表
	dgKeepList: NewApiRootUrl + 'upkeep/queryList.do',
	//单个用户的客户管理列
	ServiceGoods: NewApiRootUrl + 'index/serviceGoods',
	//首页所有商品
	QueryList: NewApiRootUrl + 'upkeep/queryList.do',
	//单个客户的维护列表
	WhSave: NewApiRootUrl + 'upkeep/save.do',
	//维护历史保存
	WhUpdate: NewApiRootUrl + 'upkeep/update.do',
	//维护历史修改
	QueryObject: NewApiRootUrl + 'upkeep/queryObject.do',
	//
	CustomerObject: NewApiRootUrl + 'customer/queryObject.do',
	IsRealValidate: NewApiRootUrl + 'customer/isRealValidate.do',
	//实名认证
	BirthdayList: NewApiRootUrl + 'user/getBirthdayList',
	//生日列表
	Holiday: NewApiRootUrl + 'user/getHoliday',
	//节假日提醒
	CreateCode: NewApiRootUrl + 'auth/createCode',
	UserInfoById: NewApiRootUrl + 'user/getUserInfoById.do',
	//获取实名认证信息
	DtoLis: NewApiRootUrl + 'customer/queryDtoList.do',
	//获取客户信息
	GetCount: NewApiRootUrl + 'customer/getCount.do',
	//获取客户统计
	UpkeepUpdate: NewApiRootUrl + 'upkeep/update.do',
	//编辑维护历史,
	CouponListByMer: NewApiRootUrl + 'coupon/listMer.do',
	//商户优惠卷
	TakeMerCoupon: NewApiRootUrl + 'coupon/getMerCoupon.do',
	//商户优惠卷
	ValidCouponList: NewApiRootUrl + 'coupon/getValidCouponList.do',
	//选择优惠卷列表
	FansList: NewApiRootUrl + 'user/getSonUser',
	//我的粉丝
	FUser: NewApiRootUrl + 'user/getFUser',
	//我的推荐人
	Commission: NewApiRootUrl + 'user/getMlsUser',
	//佣金
	InsShareGoods: NewApiRootUrl + 'user/insShareGoods',
	//新增分享历史
	GetShareGoods: NewApiRootUrl + 'user/getShareGoods',
	//获取分享历史
	WithdrawCashes: NewApiRootUrl + 'user/withdrawCashes',
	//提现
	SetFid: NewApiRootUrl + 'mlsuser/setFid',
	//mlsuser/setFid
	GroupList: NewApiRootUrl + 'goods/group.do',
	//团购
	KillList: NewApiRootUrl + 'goods/kill.do',
	//秒杀
