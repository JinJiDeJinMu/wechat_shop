<template>
	...
	<view class="container">
		<view class="cont">
			...
			<view class="selinfo"><label>获取你的公开信息（昵称、头像、地区及性别）</label></view>
			<view class="bottom-btn"><button class="r" open-type="getUserInfo" @getuserinfo="bindGetUserInfo">同意</button></view>
			<view class="bottom-new" v-if="id == -2"><button class="r" @tap="goUrl">拒绝</button></view>
		</view>
	</view>
</template>
